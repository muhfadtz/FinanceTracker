        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="flex border border-gray-200 dark:border-gray-700 rounded-lg p-1 bg-gray-100 dark:bg-gray-900">
              <button
                ...
                className={`w-1/2 p-2 rounded-md font-semibold transition-colors ${
                  type === 'expense'
                    ? 'bg-red-100 text-red-600 shadow-sm dark:bg-red-500/20'
              ...
              <button
                ...
                className={`w-1/2 p-2 rounded-md font-semibold transition-colors ${
                  type === 'income'
                    ? 'bg-green-100 text-green-600 shadow-sm dark:bg-green-500/20'
                    : 'text-gray-500 dark:text-gray-400'
                }`}
              >
                {t('income')}
          ...
          <div className="flex gap-4">
            <button
              type="button"
              onClick={onClose}
              className="w-full py-3 rounded-lg bg-gray-200 text-gray-700 font-bold hover:bg-gray-300 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500 transition-colors"
            >
              {t('cancel')}
            </button>
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 rounded-lg bg-evvo-green-dark text-white font-bold hover:bg-evvo-green-medium transition-colors flex justify-center items-center disabled:opacity-50"
            >
              {isLoading ? (
